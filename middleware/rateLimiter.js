 ...
 */
const createRateLimiter = (windowMs = 15, max = 100, message = 'Too many requests, please try again later') => {
...
const authLimiter = createRateLimiter(15, 10, 'Too many authentication attempts, please try again after 15 minutes');
const apiLimiter = createRateLimiter(15, 100, 'Too many API requests, please try again after 15 minutes');
const voteLimiter = createRateLimiter(5, 20, 'Too many voting attempts, please try again after 5 minutes');
